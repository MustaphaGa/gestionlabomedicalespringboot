...
public class PatientValidator {
	...
	public static List<String> validate(PatientDTO patientdto){
		...
		if(patientdto == null) {
			...
			errors.add("veuillez renseigner login de patient!!");
			errors.add("veuillez renseigner le password de patient!!");
	...
	if(!StringUtils.hasLength(patientdto.getLogin())) {
		errors.add("veuillez renseigner login de patient!!");
		}
	
	if(!StringUtils.hasLength(patientdto.getPassword())) {
		errors.add("veuillez renseigner le password de patient!!");
		}
