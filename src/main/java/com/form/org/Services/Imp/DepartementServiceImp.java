...
public class DepartementServiceImp implements DepartementService{
	...
	@Autowired
	public  DepartementServiceImp(DepartementRepository depatementRepository) {
	...
	public DepartementDTO save(DepartementDTO dto) {
		...
		if(!errors.isEmpty()) {
			...
			throw new InvalidEntityException("la patient n'est pas valide", ErrorCodes.DEPARTEMENT_NOT_VALID, errors);
		}
		return DepartementDTO.fromEntity(
				depatementRepository.save(
				DepartementDTO.toEntity(dto)	
						)
				);
	}
