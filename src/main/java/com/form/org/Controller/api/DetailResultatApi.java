...
public interface DetailResultatApi {
	...
	@ApiResponses(value = {
		@ApiResponse(code = 2000, message = "l'objet detail Resultat cree / modifie")	
	})
	...
	@ApiResponses(value = {
		@ApiResponse(code = 2000, message = "la detail Resultat a ete trouver dans la BDD"),	
	...
	@DeleteMapping(value =APP_ROOT + "detailResultat/delete/{idDetailResultat}" )
	 ...
	 @ApiOperation(value = "supprimer  un detail Resultat ",notes = "Cette methode permet de supprimer un detail Resultat par ID ",
 	 response = DetailResultatDTO.class)
 	    @ApiResponses(value = {
 		@ApiResponse(code = 2000, message = "detail Resultat a ete supprimer"),	
 		})
	void delecte(Integer idDetailResultat);
